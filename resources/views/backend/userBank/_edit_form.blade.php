...
<div class="form-group {{ $errors->has('account_number') ? 'has-error' : '' }}">
    ...
    <div class="col-md-8">
        {{ Form::text(fake_field('account_number'),  old('account_number', $bankName->account_number), ['class'=>'form-control', 'id' => fake_field('account_number'),'data-cval-name' => 'The Account Number field','data-cval-rules' => 'required|escapeInput|max:255', 'placeholder' => __('ex: Your Account Number')]) }}
